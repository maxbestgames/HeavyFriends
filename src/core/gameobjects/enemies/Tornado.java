...
public class Tornado extends Enemy {
	...
	public Tornado(int x, int y, EntityID id, EnemyType type) {
		super(x, y, id, type);
		...
		tex = new Texture("assets/spritemaps/windguy.png", 64, 64);
		
		walk = new Animation(7, tex.getSprite(1, 0), tex.getSprite(2, 0), tex.getSprite(3, 0), tex.getSprite(4, 0), tex.getSprite(5, 0) , tex.getSprite(6, 0), tex.getSprite(7, 0), tex.getSprite(8, 0), tex.getSprite(9, 0), tex.getSprite(10, 0), tex.getSprite(11, 0));
